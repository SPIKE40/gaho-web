import { TooltipIconButton } from "@/components/canvas/ui/assistant-ui/tooltip-icon-button";
import { Button } from "@/components/canvas/ui/button";
import { Checkbox } from "@/components/canvas/ui/checkbox";
import {
  Dialog,
  DialogContent,
  DialogDescription,
  DialogHeader,
  DialogTitle,
} from "@/components/canvas/ui/dialog";
import { Input } from "@/components/canvas/ui/input";
import { Label } from "@/components/canvas/ui/label";
import { Textarea } from "@/components/canvas/ui/textarea";
...
import { InlineContextTooltip } from "@/components/canvas/ui/inline-context-tooltip";
import { useStore } from "@/hooks/useStore";
import { useToast } from "@/hooks/use-toast";
import { v4 as uuidv4 } from "uuid";
import { CustomQuickAction } from "@opencanvas/shared/types";
import { TighterText } from "@/components/canvas/ui/header";
