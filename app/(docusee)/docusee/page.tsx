...
function App() {
  ...
  const handleDownload = () => {
    ...
    const jsonString = JSON.stringify(jsonRawData?.docs[selectedDocIndex], null, 2);
      ...
      <div className="main-content">
        ...
        <div className="right-panel">
          <Tabs>
            ...
            <Tab label="JSON">
              <div className="download-button-container" style={{ margin: '20px' }}>
